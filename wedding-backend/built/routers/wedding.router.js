...
router.get("/seed", (0, express_async_handler_1["default"])(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, wedding_model_1.ItemModel.countDocuments()];
            case 1:
                itemCount = _a.sent();
                if (itemCount > 0) {
                ...
                return [4 /*yield*/, wedding_model_1.ItemModel.create(data_1.example_weddingStage)];
            case 2:
                _a.sent();
...
router.get("/", (0, express_async_handler_1["default"])(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, wedding_model_1.ItemModel.find({ type: 'stage' })];
            case 1:
                stage = _a.sent();
                res.send(stage);
                return [2 /*return*/];
